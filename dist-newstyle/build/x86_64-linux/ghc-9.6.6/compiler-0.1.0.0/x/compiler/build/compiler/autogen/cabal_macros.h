...
/* package hegg-0.6.0.0 */
#ifndef VERSION_hegg
#define VERSION_hegg "0.6.0.0"
#endif /* VERSION_hegg */
#ifndef MIN_VERSION_hegg
#define MIN_VERSION_hegg(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  6 || \
  (major1) == 0 && (major2) == 6 && (minor) <= 0)
#endif /* MIN_VERSION_hegg */
...
#define CURRENT_COMPONENT_ID "compiler-0.1.0.0-inplace-compiler"
